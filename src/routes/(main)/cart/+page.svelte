			...
			{:else}
						...
						<div class="flex gap-4 bg-gray-900 px-4 py-3">
							...
							<div class="flex flex-1 flex-col justify-center">
								...
								<p class="text-white text-sm font-medium leading-normal mt-1">
									Subtotal: {((Number(item.price || 0) * Number(item.qty || 0)).toFixed(2))} NETSPH
								</p>
							</div>
							<button 
				...
				<div class="p-4">
					<div class="flex justify-between gap-x-6 py-2">
						...
						<p class="text-white text-sm font-normal leading-normal text-right">{subtotal.toFixed(2)} NETSPH</p>
					</div>
					<div class="flex justify-between gap-x-6 py-2">
					...
					<div class="flex justify-between gap-x-6 py-2">
						...
						<p class="text-white text-sm font-normal leading-normal text-right">{total.toFixed(2)} NETSPH</p>
					</div>
				</div>
